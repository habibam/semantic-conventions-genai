...
[developers recommendations]: https://github.com/open-telemetry/semantic-conventions/blob//docs/general/naming.md#recommendations-for-application-developers
